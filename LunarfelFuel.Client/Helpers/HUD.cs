...
namespace Lunarfel.LunarfelFuel.Client.Helpers
{
	public class HUD
	{
		...
		public void InstructTurnOffEngine()
		{
			...
			buttons.CallFunction("SET_DATA_SLOT", 0, Function.Call<string>((Hash)0x0499D7B09FC9B407, 2, (int)LunarfelFuelService.engineToggleControl, false), "Turn off engine");
		...
		public void InstructRefuelOrTurnOnEngine()
		{
			...
			buttons.CallFunction("SET_DATA_SLOT", 1, Function.Call<string>((Hash)0x0499D7B09FC9B407, 2, (int)LunarfelFuelService.engineToggleControl, 0), "Turn on engine");
